...
Examples:
```bash
$ curl "https://hipapi.datadrivendetroit.org/1.0/tabulation/01001"
{
...
Examples:
```bash
$ curl "https://hipapi.datadrivendetroit.org/1.0/table/B01001A"
{
    "table_id": "B01001A",
...
Examples:
```bash
$ curl "https://hipapi.datadrivendetroit.org/2.0/table/latest/B01001A"
{
    "table_id": "B01001A",
    "table_title": "Sex by Age (White Alone)",
    "simple_table_title": "Sex by Age (White Alone)",
...
Examples:
```bash
$ curl "https://hipapi.datadrivendetroit.org/1.0/geo/tiger2017/04000US55"
{
    "geometry": null,
    "type": "Feature",
    "properties": {
...
$ curl "https://hipapi.datadrivendetroit.org/1.0/geo/tiger2017/04000US55?geom=true"
{
    "geometry": {
        "type": "Polygon",
        "coordinates": [
...
Examples:
```bash
$ curl "https://hipapi.datadrivendetroit.org/1.0/geo/tiger2017/04000US55/parents"
{
    "parents": [
        {
            "sumlevel": "040",
...
Examples:
```bash
$ curl "https://hipapi.datadrivendetroit.org/1.0/data/show/latest?table_ids=B13016&geo_ids=04000US55"
{
    "release": {
        "id": "acs2013_1yr",
